    ...
    [cuelloMesh, atomizerGroup, bottleGroup].forEach((target) => {
      ...
      target.traverse((child) => {
        ...
        if (
          ...
          child.name === 'bodyFrontPhotoProjection' ||
          child.name === 'bodyBackPhotoProjection' ||
          child.name === 'capFrontPhotoProjection' ||
          child.name === 'capBackPhotoProjection' ||
...
// ==========================================================================
// 8. Transición Frontal y Posterior (Facing y Opacidades)
// ==========================================================================
...
function animate() {
  ...
  // 8. Transición frontal y posterior con normal única
  if (bottleGroup) {
